...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/inventorymanagement/materialmasterui/test/integration/FirstJourney",
    "com/inventorymanagement/materialmasterui/test/integration/UserListJourney",
    "com/inventorymanagement/materialmasterui/test/integration/UserObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
